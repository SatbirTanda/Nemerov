...
#define PLIST_FILENAME @"/var/mobile/Library/Preferences/com.sst1337.Nemerov.plist"
...
- (NSString *)randomAnimation
{
    NSArray *Animations =    @[AMERICANFLAG, RIPPLE, CHECKERBOARD, TRIFORCE, EXPAND, SHRINK, DOUBLECOLORFLASH, 
                                FLASHANDREVERSE, STAROFDAVID, CROSS, OTTOMAN];
...
- (void)shrinkFadeEffect:(UIView *)screenShotView fromDirection:(NSString *)direction 
{
  ...
  [UIView animateKeyframesWithDuration:1.0
                ...
                animations:^{
                          ...
                          screenShotView.frame = shrinkRect;
                } 
...
- (void)expandFadeEffect:(UIView *)screenShotView fromDirection:(NSString *)direction 
{
    ...
    screenShotView.frame = [self newRect:(screenShotView.frame) withDirection:(direction)];
    screenShotView.alpha = 0.0;
    [UIView animateWithDuration:1.0 
                          delay:0.0 
                        options:UIViewAnimationOptionAllowUserInteraction  
                      animations:^{
                        screenShotView.frame =  [[[[%c(UIApplication) sharedApplication] windows] lastObject] frame];
     ...
     [UIView animateWithDuration:0.5
                      ...
                      animations:^{
                          ...
                          [UIView animateWithDuration:0.4
                                           ...
                                           animations:^{
                                               screenShotView.frame = finalRect;
                                               screenShotView.alpha = 0.0;
                                           }
                                           completion:^(BOOL finished) {
                                               [screenShotView removeFromSuperview];
